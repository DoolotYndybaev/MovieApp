...
class ViewController3: UIViewController {
    ...
    private lazy var janrButtons: UIButton = {
        ...
        view.setTitle("Movie", for: .normal)
    ...
    private lazy var janrButtons2: UIButton = {
        let view = UIButton(type: .system)
        view.setTitleColor(.black, for: .normal)
        view.setTitle("Pixar", for: .normal)
        view.layer.cornerRadius = 15
        view.layer.borderWidth = 1
        view.layer.borderColor = CGColor(red: 128/255, green: 128/255, blue: 128/255, alpha: 1)
        return view
    ...
    private lazy var janrButtons3: UIButton = {
        let view = UIButton(type: .system)
        view.setTitleColor(.black, for: .normal)
        view.setTitle("Disney", for: .normal)
        view.layer.cornerRadius = 15
        view.layer.borderWidth = 1
        view.layer.borderColor = CGColor(red: 128/255, green: 128/255, blue: 128/255, alpha: 1)
        return view
    ...
    private lazy var summaryDescriptionMovies1: UILabel = {
        let view = UILabel()
        view.text = """
        The film centers on a music teacher Joe Gardner (Foxx) seeking to reunite his soul and his body after they are separated, just before his big break as a jazz musician. Docter conceived Soul in January 2016, working from his contemplations on the origins of human personalities and the concept of determinism.
        """
